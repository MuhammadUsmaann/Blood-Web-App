...
namespace BloodDonationWebApp.Database
{
	public abstract class IRepository<T> : IDisposable where T : class
	{
        ...
        protected IRepository()
		{
            try
            {
                var ConnectionString = @"Data Source=USMAN;Initial Catalog=BloodDonationApp;User ID=admin;Pwd=bitf10m030;Connect Timeout=15";
